...
/// @nodoc
abstract class $LocationResultCopyWith<T, $Res> {
  factory $LocationResultCopyWith(
          LocationResult<T> value, $Res Function(LocationResult<T>) then) =
      _$LocationResultCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$LocationResultCopyWithImpl<T, $Res>
    implements $LocationResultCopyWith<T, $Res> {
  _$LocationResultCopyWithImpl(this._value, this._then);

  final LocationResult<T> _value;
  // ignore: unused_field
  final $Res Function(LocationResult<T>) _then;
}
...
class _$SuccessCopyWithImpl<T, $Res>
    extends _$LocationResultCopyWithImpl<T, $Res>
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'LocationResult<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements LocationResult<T> {
...
class _$Failure<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'LocationResult<$T>.failure(error: $error, message: $message)';
  }
...
abstract class Failure<T> implements LocationResult<T> {
