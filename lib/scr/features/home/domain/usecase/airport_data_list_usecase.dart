...
@lazySingleton
class AirportListFromLocalUseCase extends BaseUseCaseNoArgs<ApiResult<List<AirportEntity>?>> {
  AirportListFromLocalUseCase(
  ...
  Future<ApiResult<List<AirportEntity>?>> call() async {
    final ApiResult<List<AirportEntity>?> result = await _airportRepository.getAirportList();
    return result;
  }
}
